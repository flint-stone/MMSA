...
def MMSA_test(
    ...
    print(f"feature keys test {feature['test'].keys()}")
    print(f"feature keys valid {feature['valid'].keys()}")
    print(f"feature keys train {feature['train'].keys()}")
    ...
    def SENA_run(
        ...
        try:
            ...
            try:
                ...
                setup_seed(seed)
                # actual training
                results_dict = _run(args, num_workers, is_tune, from_sena=True, modality_skips_str="")
                # db operations
                sample_dict = {}
